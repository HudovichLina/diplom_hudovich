...
from .views import category_list, product_list, product_detail, order_success, order_list_of_all_users, order_create, wish_list, wish_like, wish_dislike, order_list_user_self, user_reviews, calculate_order_cost, search
